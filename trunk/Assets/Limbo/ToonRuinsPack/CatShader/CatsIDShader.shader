Shader "CatOnTheRoof/Cat'sIDShader"
{
	Properties 
	{
_Diffuse("Diffuse", 2D) = "gray" {}
_Normal("Normal", 2D) = "bump" {}
_SpecPower("SpecularPower", Range(0,1) ) = 0.4867226
_Spec("Specular", 2D) = "black" {}
_Color("ID Color", Color) = (1,0.01568329,0.01568329,0.5019608)
_Alpha("ID Alpha", 2D) = "black" {}
...
float4 Multiply1=_Color * Tex2D3;
float4 Tex2D1=tex2D(_Diffuse,(IN.uv_Diffuse.xyxy).xy);
float4 Add0=Multiply1 + Tex2D1;
...
float4 Multiply0=Tex2D2 * _SpecPower.xxxx;
